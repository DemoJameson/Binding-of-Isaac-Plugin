...
function hookGiveit() {
	...
	while (v2 == 0) {
		...
		if (bPickedAllItems) {
			...
			// ↑ Fix Bug The last shop item in pool can't appear
			_level.a.bummer = false;
			...
			// ↑ Fix Bug If the pool is empty, then the game can't generate any more Boss RoomSecret RoomBoss Changell Room Items so it gives you Undefined
